//
//  TaskPageAlertCloseTaskView.swift
//  AntiProcrastinator
//
...
final class TaskPageAlertCloseTaskView: UIView {
...
// MARK: Public
extension TaskPageAlertCloseTaskView {
    func initialize() {
...
private extension TaskPageAlertCloseTaskView {
...
private extension TaskPageAlertCloseTaskView {
    ...
    func makeTitleLabel() -> UILabel {
        ...
        let view = UILabel()
        view.attributedText = "TaskPage.AlertCloseTaskTitle.Text".localized.attributed(with: attr)
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    func makeTextLabel() -> UILabel {
        ...
        let view = UILabel()
        view.attributedText = "TaskPage.AlertCloseDescription.Text".localized.attributed(with: attr)
        view.translatesAutoresizingMaskIntoConstraints = false
    ...
    func makeCloseButton() -> UIButton {
        ...
        let view = UIButton()
        view.setAttributedTitle("TaskPage.AlertCloseTaskButton.Text".localized.attributed(with: attr), for: .normal)
