...
final class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        mainView.setup(fatiguePoints: output.fatiguePoints, fatigueLevel: output.fatigueLevel)
        mainView.tableView.didSelectItem = { [weak self] selectedTask in
            ...
            vc.taskCloseCompletionHandler = { [weak self] in
                ...
                self?.mainView.setup(fatiguePoints: updatedOutput.fatiguePoints, fatigueLevel: updatedOutput.fatigueLevel)
            }
